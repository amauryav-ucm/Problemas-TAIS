...
public:
   ...
   T const kesimo(Link a, const int k, const int acum) const
   {
      if (a == nullptr)
         return -1;
      if (a->tam_i + acum == k)
         return a->elem;
      else if (k < a->tam_i + acum)
         return kesimo(a->iz, k, acum);
      else
         return kesimo(a->dr, k, acum + a->tam_i);
   }
...
protected:
   ...
   {
      Link r1 = r2->iz;
      int tam_der = r2->tam_i - r2->iz->tam_i;
      r2->iz = r1->dr;
      r2->tam_i = tam_der;
      r1->dr = r2;
